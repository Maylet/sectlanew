...
<body>
    ...
    <div class="row">
        ...
        <div class="span12 gallery-single">
            ...
            <div class="row">
                <div class="span6">
                    <img src="img/gallery/model4.png" height="354" width="770" class="align-left thumbnail" alt="image">
                </div>
                <div class="span6">
                    <h2>Bar la Ciega</h2>
                    <p class="lead">El lugar donde encuentras comodidad y seguridad</p>
                    <p>un espacio donde tu disfrutaras de los mejores vinos y licores.</p>
