...
<body>
    ...
    <div class="row">
        ...
        <div class="span12 gallery-single">
            ...
            <div class="row">
                <div class="span6">
                    <img src="img/gallery/model4.jpg" height="354" width="770" class="align-left thumbnail" alt="image">
                </div>
                <div class="span6">
                    <h2>Hotel las cabañas</h2>
                    <p class="lead">El lugar donde encuentras comodidad y seguridad</p>
                    <p>un espacio donde tu y tu familia pueden encontrar toda aquella comodidad que les ofrece este magico encuentro hacia la naturaleza.</p>
